  ...
  return (
    ...
    <div className='w-11/12 m-auto'>
      ...
      <div className={`shadow-md rounded-md p-6 w-3/4 my-4 ${drk_theme?"bg-bg_dark_sec text-font_dark_pri":"bg-bg_light_sec text-font_light_pri"}`}>
        ...
        <input type="password" required value={userData.password} name="password" onChange={handleChange} placeholder='your password' className='bg-transparent w-2/3 outline-none px-2 mx-2' />
        </label>
