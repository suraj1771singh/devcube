...
id:number,email:string,photo?:string
}
interface propsType{
  data:participantsDataType[]
}
const Participants = ({data}:propsType) => {
  ...
  return (
    ...
    <div className='grid grid-col-1 gap-3' >
      ...
      {
        data?.map((el:participantsDataType)=><div key={el.id} className='flex items-center justify-between py-2  px-4'>
      <div>
