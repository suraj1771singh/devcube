        ...
        <>
            <div className='md:w-[54%] ml-[19.3%] animate-in slide-in-from-bottom-48 ease-in-out duration-500'>
               <div className={`${drk_theme ? "bg-bg_dark_sec text-font_dark_pri" : "bg-bg_light_sec text-font_light_pri"} rounded-2xl shadow-md overflow-hidden`} >
                    {/* profile Div  */}
                    {get_user_error?<div className='w-full h-52 flex justify-center items-center'><Error text='Error while Getting User Details !'/></div>:get_user_loading?<div className='w-full h-52 flex justify-center items-center'><Loader text='Fetching User Details..'/></div>:<div className='' >
